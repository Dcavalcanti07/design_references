...
| Hologram Gradient | `linear-gradient(270deg, rgb(255, 163, 182), rgb(221, 169, 255) 33%, rgb(162, 209, 255) 66%, rgb(255, 163, 182))` | `--color-hologram-gradient` | Supporting palette color for small decorative accents when the core palette needs contrast. Do not promote it to the primary CTA color |
...
### NaNArchyONExtraBlack_PREVIEW — Largest display headlines for font showcases, characterized by its extra-black weight and unique 'ON' style. · `--font-nanarchyonextrablackpreview`
...
|------|------|-------------|----------------|-------|
| caption | 12px | 1.5 | 0.075px | `--text-caption` |
| body | 14px | 1.5 | 0.075px | `--text-body` |
...
:root {
  ...
  --gradient-hologram-gradient: linear-gradient(270deg, rgb(255, 163, 182), rgb(221, 169, 255) 33%, rgb(162, 209, 255) 66%, rgb(255, 163, 182));
  ...
  --font-nansuperxseriftextthinitalicpreview: 'NaNSuperXSerifTextThinItalicPREVIEW', ui-serif, Georgia, Cambria, "Times New Roman", Times, serif;
  --font-nansuperxsansdisplayblackpreview: 'NaNSuperXSansDisplayBlackPREVIEW', ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;
  --font-nanarchyonextrablackpreview: 'NaNArchyONExtraBlack_PREVIEW', ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;
  --font-nanhologigawideultra1: 'NaNHoloGigawideUltra1', ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;
  ...
  /* Surfaces */
  --surface-page-canvas: #b7ffb4;
  --surface-secondary-surface: #262626;
